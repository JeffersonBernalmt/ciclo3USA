...
import co.edu.usa.reto3.services.UserAdministratorService;
...
public class UserAdministratorController {
    @Autowired
    private UserAdministratorService usuAdmnService;
    ...
    public UserAdministator save(@RequestBody UserAdministator usuAdmn){
